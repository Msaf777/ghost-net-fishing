...
public class UserServiceTest {
    ...
    /**
     * Tests that the isPersonReporterAndLoggedIn method returns true if the user is logged in and is a Reporter.
     */
    @Test
    void whenIsPersonReporterAndLoggedIn_thenReturnTrueIfLoggedInAndPersonIsReporter() {
        // Arrange
        mockPerson.setType(PersonType.REPORTER);
        sessionUtilMockedStatic.when(SessionUtil::isLoggedIn).thenReturn(true);
        sessionUtilMockedStatic.when(SessionUtil::getLoggedInPerson).thenReturn(mockPerson);
        ...
        // Act
        boolean result = userService.isPersonReporterAndLoggedIn();
    ...
    /**
     * Tests that the isPersonReporterAndLoggedIn method returns false if the user is not logged in.
     */
    @Test
    void whenIsPersonReporterAndLoggedIn_thenReturnFalseIfNotLoggedIn() {
        // Arrange
        sessionUtilMockedStatic.when(SessionUtil::isLoggedIn).thenReturn(false);
    ...
    /**
     * Tests that the isPersonReporterAndLoggedIn method returns false if the logged-in person is not a Reporter.
     */
    @Test
    void whenIsPersonReporterAndLoggedIn_thenReturnFalseIfPersonIsNotReporter() {
        // Arrange
        sessionUtilMockedStatic.when(SessionUtil::isLoggedIn).thenReturn(true);
        sessionUtilMockedStatic.when(SessionUtil::getLoggedInPerson).thenReturn(mockPerson);
